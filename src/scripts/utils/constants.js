...
export const userProfileSubmitBtn = formUser.querySelector(".form__submit-btn");
export const placeSubmitBtn = formPlace.querySelector(".form__submit-btn");
export const avatarForm = document.querySelector("#avatar-form")
export const avatarSubmitBtn = avatarForm.querySelector(".form__submit-btn")
